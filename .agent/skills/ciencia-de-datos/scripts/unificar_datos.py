...
def unificar_y_preparar(input_dir, output_path):
    ...
    # Generar resumen_procesamiento.txt en la raíz del proyecto universitario (5 niveles arriba de output_path)
    proyecto_root = output_path
    for _ in range(5):
        proyecto_root = os.path.dirname(proyecto_root)
...
if __name__ == "__main__":
    # Definir rutas base por defecto
    INPUT_DIR = r"C:\Users\ezebe\OneDrive\Desktop\Universidad\5to año\Ciencias de Datos\Trabajo Integrador"
    OUTPUT_PATH = r"C:\Users\ezebe\OneDrive\Desktop\Universidad\5to año\Ciencias de Datos\Trabajo Integrador\agent\skills\ciencia-de-datos\recursos\dataset_consolidado.csv"
    
    # Si la carpeta del dataset 2023 existe, priorizarla para unificar
    dataset_2023_dir = os.path.join(INPUT_DIR, "dnrpa-robos-recuperos-autos-2023")
    if os.path.exists(dataset_2023_dir):
        INPUT_DIR = dataset_2023_dir
